    ...
    <el-row>
      <div class="user-list">
        <div class="action-bar">
          ...
          <el-button type="primary" @click="$refs.AddServiceGovernance.open_dialog(true,'')" icon="el-icon-plus">新建</el-button>
        ...
        <div class="user-table">
          <el-table :data="List" stripe v-loading="loading" @selection-change="handleSelectionChange" ref="table_dom" style="width: 100%" :default-sort = "{prop: 'date', order: 'ascending'}">
            ...
            <el-table-column prop="date" label="名称" min-width="80">
            ...
            <el-table-column prop="date" label="解析域名">
