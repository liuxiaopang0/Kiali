...
exports.parseYamlValidations = exports.parseKialiValidations = exports.jsYaml = void 0;
exports.jsYaml = require('js-yaml');
...
var parseKialiValidations = function (yamlInput, kialiValidations) {
    var aceValidations = {
        markers: [],
        annotations: []
    };
...
exports.parseKialiValidations = parseKialiValidations;
var parseYamlValidations = function (yamlInput) {
    var parsedValidations = {
        markers: [],
        annotations: []
    };
    try {
        exports.jsYaml.safeLoadAll(yamlInput);
    }
    catch (e) {
...
exports.parseYamlValidations = parseYamlValidations;
