...
const destinationRuleValidations = {
  name: 'details',
...
const vsInvalidHttpSecondRoute = {
  name: 'productpage',
  objectType: 'virtualservice',
  valid: false,
  checks: [
...
const vsInvalidHttpSecondSecondDestinationField = {
  name: 'productpage',
  objectType: 'virtualservice',
  valid: false,
  checks: [
...
const vsInvalidHttpThirdFirstDestinationField = {
  name: 'productpage',
  objectType: 'virtualservice',
  valid: false,
  checks: [
...
const vsInvalidHttpThirdFirstSubsetNotFound = {
  name: 'productpage',
  objectType: 'virtualservice',
  valid: false,
  checks: [
...
const vsInvalidHttpFirstSecondSubsetNotFound = {
  name: 'productpage',
  objectType: 'virtualservice',
  valid: false,
  checks: [
...
const vsInvalidHttpFourthFirstWeigth = {
  name: 'productpage',
  objectType: 'virtualservice',
  valid: false,
  checks: [
...
const vsInvalidHttpFifthSecondWeigth = {
  name: 'productpage',
  objectType: 'virtualservice',
  valid: false,
  checks: [
